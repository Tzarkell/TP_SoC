...
/*extern soclib_fb_init_hardware (void);
extern soclib_fb_init_driver (void);
extern soclib_fb_uninit_driver (void);
extern soclib_fb_publish_devices (void);
extern soclib_fb_find_device (void);*/
#endif
